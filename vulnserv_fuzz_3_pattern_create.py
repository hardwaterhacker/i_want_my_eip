...
# Using pattern_create.rb to generate a non-repeating character
#  string allows us to easily identify how many bytes of input
#  are required to trigger the overflow.
